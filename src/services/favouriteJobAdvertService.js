...
export default class FavouriteJobAdvertService {
    ...
    delete(favouriteJobAdvertId) {
        return axios.delete("http://localhost:8080/api/favouriteJobAdverts/removeFavouriteJobAdvert?favouriteJobAdvertId=" + favouriteJobAdvertId)
    }
